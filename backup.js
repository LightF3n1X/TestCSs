...
const firebaseConfig = {
  apiKey: "AIzaSyCsj1FMi1pgV1jOpESWaBCk9uTLi_hli8I",
  authDomain: "tests-f3n1x.firebaseapp.com",
  databaseURL: "https://tests-f3n1x-default-rtdb.europe-west1.firebasedatabase.app",
  projectId: "tests-f3n1x",
  storageBucket: "tests-f3n1x.appspot.com",
  messagingSenderId: "735413278046",
  appId: "1:735413278046:web:68a7fa6834224545a1ebcf",
  measurementId: "G-PFF4NZ4180"
};
...
function addAnswer(answerContainer) {
  ...
  removeAnswerBtn.addEventListener('click', function () {
    removeAnswer(answerContainer, answerInput);
  });
